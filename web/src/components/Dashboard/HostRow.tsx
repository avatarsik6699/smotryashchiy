...
function Metric({ label, value, points, kind, format, title }: MetricProps) {
  return (
    ...
    <Accordion.Item value={view.id} className={styles.item} data-state={state}>
      <Accordion.Header className={styles.header}>
        <Accordion.Trigger className={styles.trigger}>
          ...
          <Metric label="CPU" value={value(view.cpu.value, formatPercent)} points={view.cpu.points} kind="percent" format={formatPercent} />
          <Metric label="MEM" value={value(view.memory.value, formatPercent)} points={view.memory.points} kind="percent" format={formatPercent} />
          <Metric label={diskLabel} value={value(view.disk.value, formatPercent)} points={view.disk.points} kind="percent" format={formatPercent} title={view.disk.mount ?? undefined} />
